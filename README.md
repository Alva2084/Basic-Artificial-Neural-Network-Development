...
### Use of AI
Used the help of chatGPT to think of test cases to use for TDD which is where I came across one-hot encoding and epoch. This helped me crate different test cases to pay attention to when developing the project and with the help of coPilot, it gave suggestion near perfect to what I was looking for since it knew I was going to do based on the tests written. 
